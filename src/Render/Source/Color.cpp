...
bool Render::Color::operator==(const Render::Color &rhs) const {
  return (Primitives::float_equal(this->x, rhs.x) && Primitives::float_equal(this->y, rhs.y) &&
...
Render::Color Render::Color::operator*(const Render::Color &rhs) const {
  Render::Color ret(this->red * rhs.red, this->green * rhs.green, this->blue * rhs.blue);
  return ret;
}
